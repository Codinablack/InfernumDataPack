...
enum itemAbilityTypes : uint64_t {
	...
	ITEM_ABILITY_DAMAGEMITIGATION = 1ULL << 46, // done, working
	ITEM_ABILITY_BONUSREGEN = 1ULL << 47, // might not implement
	ITEM_ABILITY_MAGICDAMAGE = 1ULL << 48, // done, working
	ITEM_ABILITY_SUPPORTHEALING = 1ULL << 49, // done, working
	ITEM_ABILITY_ATTACKSPEED = 1ULL << 50, // done, working
	ITEM_ABILITY_FLEXSKILL = 1ULL << 51, // done, working
	ITEM_ABILITY_BONUSHEALING = 1ULL << 52 // done, working
};
