...
void Events::eventPlayerOnMove(Player* player, Position fromPosition, Position toPosition, Direction direction)
{
	// Player:onMove(fromPosition, toPosition, direction)
